(function() {
    describe("Account", function() {
        beforeEach(() => {
            account = new Account(894332);
        });

        describe("getNumber", function () {
            it("returns accounts number", function () {
                    assert.equal(account.getNumber(), 894332);
                });
        });
        ...
        describe("withdraw", function () {
            ...
            describe("when the given amount is less than or equal 0", function() {
                it("throws Error with Insufficient funds", function () {
                    assert.throws(() => {account.withdraw(2000)}, Error, "Insufficient funds");
                });
            });
    ...
    describe("SavingsAccount", function() {
        beforeEach(() => {
            savingsAccount = new SavingsAccount(0.09, 894332);
        });
        ...
        describe("endOfMonth", function () {
            it("print details of savings account", function () {
                savingsAccount.deposit(100);
                savingsAccount.addInterest()
                assert.equal(savingsAccount.endOfMonth(), 'Interest added SavingsAccount 894332: balance: 100.180081 interest: 0.09');
            });
        });
    ...
    describe("CheckingAccount", function() {
        beforeEach(() => {
            checkingAccount = new CheckingAccount(1000, 894332);
        });
        ...
        describe("endOfMonth", function () {
            describe("when the balance is below zero", function() {
                it("print warning details of checking account", function () {
                    ...
                    assert.equal(checkingAccount.endOfMonth(), 'Warning, low balance CheckingAccount 894332: balance: -180 overdraft limit: 1000');
                });
            });
